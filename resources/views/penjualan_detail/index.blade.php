                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                                ...
                                <input type="hidden" name="diskonBarang" id="diskonBarang">
                                ...
                                <div class="form-group row">
                                    <label for="diskon" class="col-lg-2 control-label">Diskon Tambahan</label>
                                    <div class="col-lg-8">
                                ...
                                <div class="form-group row">
                                    <label for="selectBayar" class="col-lg-2 control-label">Metode Bayar</label>
                                    <div class="col-lg-8">
                                        <select class="form-control" name="selectBayar">
                                            <option>Pilih Metode...</option>
                                            @foreach ($varMetode as $value)
                                                <option value="{{ $value->metode_bayar }}" {{ $value->metode_bayar }}>
                                                    {{ $value->metode_bayar }}
                                                </option>
                                            @endforeach
                                        </select>
