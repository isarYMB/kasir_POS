...
class PenjualanDetailController extends Controller
{
    public function index()
    {
        ...
        if ($id_penjualan = session('id_penjualan')) {
            ...
            return view('penjualan_detail.index', compact('produk', 'varMetode', 'member', 'diskon', 'id_penjualan', 'penjualan', 'memberSelected'));
        } else {
    ...
    public function data($id)
    {
        ...
        foreach ($detail as $item) {
            ...
            // $diskonBarang += $item->diskon * $item->jumlah;
        }
        $data[] = [
            'kode_produk' => '
